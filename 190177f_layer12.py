# -*- coding: utf-8 -*-
"""190177F_Layer12.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SQQfmdhdtyiiSxYgZMleEByChf2R1mGR
"""
...
train =  pd.read_csv(r'/content/drive/My Drive/Colab Notebooks/ML_Project/Layer12/train.csv')
valid =  pd.read_csv(r'/content/drive/My Drive/Colab Notebooks/ML_Project/Layer12/valid.csv')
test = pd.read_csv(r'/content/drive/My Drive/Colab Notebooks/ML_Project/Layer12/test.csv')
train.shape
...
def lasso_feature_reduction(X_t_s,y,feature_names,th_co):
  ...
  # droppedLength = names.length - feature_subset.length
  # print("Number of features dropped",droppedLength)
  # return X_train_scaled[feature_subset]
...
feature_subset_label1=lasso_feature_reduction(X_train_scaled,y_train['label_1'],X_train_scaled_df.columns, 1.5)
...
best_params_rf_l1 = model_hyperparameter_tuning(RandomForestClassifier(),param_grid_rf,X_train_pca,y_train['label_1'])
print(best_params_rf_l1)

param_grid_rf = {'max_depth': [500,1000]}
best_params_rf_l2 = model_hyperparameter_tuning(RandomForestClassifier(),param_grid_rf,X_train_pca,y_train['label_1'])
print(best_params_rf_l2)

param_grid_rf = {'max_depth': [100], 'n_estimators':[100,300]}
best_params_rf2_l1 = model_hyperparameter_tuning(RandomForestClassifier(),param_grid_rf,X_train_pca,y_train['label_1'])
print(best_params_rf2_l1)

# Randomforest
rf_label1= RandomForestClassifier(max_depth=100, n_estimators=300, random_state=42)
...
check_model_accuracy(RandomForestClassifier(n_estimators=200),X_train_pca_without_fr,y_train['label_1'],X_valid_pca_without_fr, y_val['label_1'])

#SVM
# param_grid_svml1 = {'C': [100, 1000], 'gamma': [0.01, 0.001]}
# best_params_svm_l1 = model_hyperparameter_tuning(SVC(),param_grid_svml1,X_train_pca_without_fr,y_train['label_1'])
...
svm2_label1 = SVC(C=1000, gamma=0.01, kernel='rbf')
check_model_accuracy(svm2_label1,X_train_pca_without_fr,y_train['label_1'],X_valid_pca_without_fr, y_val['label_1'])

import lightgbm as lgb
lgb_label1= lgb.LGBMClassifier()
check_model_accuracy(lgb_label1,X_train_pca,y_train['label_1'],X_valid_pca, y_val['label_1'])

feature_subset1_label1=lasso_feature_reduction(X_train_scaled,y_train['label_1'],X_train_scaled_df.columns, 1.2)
dropped_features1_label1 =len(X_train_scaled_df.columns)-len(feature_subset1_label1)
print("Dropped features for label 1 using lasso", dropped_features1_label1)
X_train_fr1_label1 = X_train_scaled_df[feature_subset1_label1].values
X_valid_fr1_label1 = X_valid_scaled_df[feature_subset1_label1].values
X_test_fr1_label1 = X_test_scaled_df[feature_subset1_label1].values
X_train_pca1 = pca.fit_transform(X_train_fr1_label1)
X_valid_pca1 = pca.transform(X_valid_fr1_label1)
X_test_pca1 = pca.transform(X_test_fr1_label1)
check_model_accuracy(RandomForestClassifier(random_state=42),X_train_pca1,y_train['label_1'],X_valid_pca1, y_val['label_1'])
...
"""Random forest has the highest validation accuracy.
SVM has the highest cross validation.
Since the validation accuracy is low considerably for all models came to a conclusion that SVM is the best model for Label1.
...
print(label2_train['label_2'].isnull().sum())
print(label2_valid['label_2'].isnull().sum())
...
# Randomforest
rf_label2= RandomForestClassifier(max_depth=100, n_estimators=300, random_state=42)
...
# Randomforest
rf_label2= RandomForestClassifier(random_state=42)
check_model_accuracy(rf_label2,X_train_label2_pca,y_train_label2['label_2'],X_valid_label2_pca, y_valid_label2['label_2'])
...
check_model_accuracy(SVC(C=100, gamma=0.001, kernel='rbf'),X_train_label2_pca_without_fr,y_train_label2['label_2'],X_valid_label2_pca_without_fr, y_valid_label2['label_2'])

svm1_label2 = SVC(C=1000, gamma=0.001, kernel='rbf')
#svm without fearure reduction
check_model_accuracy(svm1_label2,X_train_label2_pca_without_fr,y_train_label2['label_2'],X_valid_label2_pca_without_fr, y_valid_label2['label_2'])
...
svm1_label3 = SVC(C=1000, gamma=0.001, kernel='rbf')
check_model_accuracy(svm1_label3,X_train_pca_without_fr,y_train['label_3'],X_valid_pca_without_fr, y_val['label_3'])
...
rf_label4= RandomForestClassifier()
check_model_accuracy(rf_label4,X_train_pca_without_fr,y_train['label_4'],X_valid_pca_without_fr, y_val['label_4'])

svm_label4 = SVC(C=100, gamma=0.001, kernel='rbf')
...
check_model_accuracy(svm_label4,X_train_pca_label4,y_train['label_4'],X_valid_pca_label4, y_val['label_4'])
...
output_df.to_csv('prediction_layer12.csv', index=False)
files.download('prediction_layer12.csv')